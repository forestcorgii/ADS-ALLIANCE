...
#Region "Message Boxes"
    ...
    Public Sub msgBox_Out(ByVal msg As String, Optional ByVal caption As String = "", Optional ByVal width As Integer = 300, Optional ByVal height As Integer = -1)
        If msg_out.Created = False Then
            Dim h As Integer = height
            If height = -1 Then
                h = msg_in.Height
            End If
            ...
            msg_out.lblMsg.Text = msg
            msg_out.Text = caption
            msg_out.ShowDialog()
        End If
    End Sub
