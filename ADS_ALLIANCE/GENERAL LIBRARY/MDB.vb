...
Public Class MDB
    Public Shared Provider As String = "Provider=Microsoft.JET.OLEDB.4.0;Data Source="
    Public Shared conData, conE1, conE2, conClient As OleDb.OleDbConnection
#Region "OPEN"
    Public Shared Sub mdbOpen(ByVal DatabaseFullPath As String, ByRef con As OleDbConnection)
        Try
    ...
    Public Shared Function mdbOpen(ByVal DatabaseFullPath As String, ByRef con As OleDbConnection, ByVal mode As Boolean)
        Try
            If mode Then
...
#Region "Delete"
    Public Shared Sub mdbDrop(ByVal tbls As String(), ByVal con As OleDbConnection)
...
#Region "Create"
    Public Shared Sub mdbCreate(ByVal DatabaseFullPath As String)
        Try
    ...
    Public Shared Sub mdbCreateTable(ByVal tbl As String, ByVal flds As String(), ByVal con As OleDbConnection)
    ...
    Public Shared Sub mdbCreateTable(ByVal tbl As String, ByVal flds As DataTable, ByVal DDTT As String, ByVal con As OleDbConnection)
        Dim qry As String = String.Format("CREATE TABLE {0}(", tbl)
    ...
    Public Shared Sub mdbCreateTable(ByVal tbl As String, ByVal flds As DataGridView, ByVal DDTT As String, ByVal con As OleDbConnection)
        Dim qry As String = String.Format("CREATE TABLE {0}(", tbl)
...
#Region "Convert"
    Public Shared Sub mdbToDT(ByVal qry As String, ByRef dt As System.Data.DataTable, ByVal con As OleDbConnection)
        Try
            dt = New DataTable
...
#Region "Commands"
    Public Shared Sub executeQRY(ByVal Qry As String, ByVal con As OleDbConnection)
        Try
    ...
    Public Shared Sub mdbInsert(ByVal tbl As String, ByVal fld As String(), ByVal val As Object(), ByVal con As OleDbConnection)
    ...
    Public Shared Sub mdbUpdate(ByVal tbl As String, ByVal fld As String(), ByVal val As Object(), ByVal condition As Object(), ByVal con As OleDbConnection)
...
#End Region
    ...
    Public Shared Function getTables(ByVal con As OleDbConnection) As List(Of String)
    ...
    Public Shared Sub mdbCreateDataTBL(ByRef con As OleDbConnection)
    ...
    Public Shared Sub mdbCreateCBatch(ByVal tbl As String, ByVal con As OleDb.OleDbConnection)
