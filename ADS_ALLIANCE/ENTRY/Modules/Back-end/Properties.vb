...
#Region "Menu Item"
    ...
    Private mnCom As ToolStripMenuItem
    Private mnReCom As ToolStripMenuItem
    Private mnQC As ToolStripMenuItem
...
#Region "Datagridview"
    Public Property CurrentRow() As Integer
        ...
        Set(ByVal value As Integer)
            'Dim flag As Integer = value - dgv.CurrentCell.RowIndex
            'If flag = 1 Then
            '    If fromMailingFiles(FIELDNAME, CurrentFieldValue) Then value += 1
            'Else
            '    If fromMailingFiles(FIELDNAME, CurrentFieldValue) Then value -= 1
            'End If
            Try
